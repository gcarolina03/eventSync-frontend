...
function AddItem({onClick, icon, text}) {
  return (
    <div onClick={onClick} className="bg-white border border-gray-200 relative items-center flex cursor-pointer justify-center rounded-lg h-[380px] w-[300px] shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
